...
var GenerateTranscript_1 = require("../model/GenerateTranscript");
var GetAccount_1 = require("../model/GetAccount");
...
var Client = /** @class */ (function () {
    function Client(endpoint) {
        ...
        this.generateTranscript = new Operation_1.Operation(endpoint, GenerateTranscript_1.GenerateTranscriptResource, GenerateTranscript_1.GenerateTranscriptRequestSchema, GenerateTranscript_1.GenerateTranscriptResponseSchema);
        this.getAccount = new Operation_1.Operation(endpoint, GetAccount_1.GetAccountResource, GetAccount_1.GetAccountRequestSchema, GetAccount_1.GetAccountResponseSchema);
    }
    return Client;
}());
