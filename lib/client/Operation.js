...
var Operation = /** @class */ (function () {
    ...
    Operation.prototype.invoke = function (requestBody) {
        return __awaiter(this, void 0, void 0, function () {
            var response, x, responseBody, _1, _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        ...
                        responseBody = this.responseSchema.parse(x);
                    ...
                    case 6:
                        _a = Error_1.ResponseError.bind;
                        _b = [void 0, response.status];
                        return [4 /*yield*/, response.text()];
                    case 7: throw new (_a.apply(Error_1.ResponseError, _b.concat([_c.sent()])))();
